Gem::Specification.new do | s |
    s.name        = 'temperature_converter_bl'
    s.version     = '1.0.0'
    s.date        = '2017-11-11'
    ...
    s.files       = [
                      'lib/temperature_converter_bl.rb', 'lib/temperature_converter/celsius_strategy.rb',
    ...
    s.homepage    = 'http://rubygems.org/gems/temperature_converter_bl'
    s.license     = 'MIT'
